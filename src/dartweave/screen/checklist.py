...
READING_ORDER: tuple[tuple[str, str, str], ...] = (
    ("1", "맨 위 한 줄 · 10초",
     "몇 개 걸렸는지와 **그 구간의 실측 부실률**입니다. 0개면 사실상 여기서 끝나도 "
     "됩니다 — 0개 걸린 회사의 이후 2년 부실률은 0.00~0.20%로, 상장사 전체 평균"
     "(1.5~2.4%)의 10분의 1도 안 됩니다."),
    ("2", "걸린 항목 카드 · 항목당 1분",
     "카드 한 장은 네 줄로 읽습니다. **무엇인지**(첫 줄 설명) → **얼마나 나쁜지**"
     "(상장사·업종 안에서의 위치) → **나아지는 중인지**(3년 추세) → **이 신호가 실제로 "
     "얼마나 맞는지**(실측 부실률)."),
    ("3", "각 카드의 '다만' 줄 · 항목당 10초",
     "걸린 회사의 **스무 중 열아홉은 2년 안에 아무 일도 없었습니다**. 이건 유죄 판정이 "
     "아니라 여기서 멈추고 이유를 찾아보라는 표시입니다. 이 줄을 건너뛰면 리포트를 "
     "실제보다 세게 읽게 됩니다."),
    ("4", "확인하지 못한 것 · 2분",
