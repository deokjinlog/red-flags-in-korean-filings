...
FAMILY = [
    # 재무 — 재무 신호에는 그래프 소속을 요구하지 않는다(그러면 DART 타법인출자
    # API 의 연도별 수록 편차가 표본을 좌우한다). scripts/test_financial_signals.py
    ("결손금 · T=2021",            0.0001, "채택"),
    ("결손금 · T=2022",            0.0001, "채택"),
    ("결손금 · T=2023",            0.0005, "채택"),
    ("영업손실 · T=2021",          0.0024, "채택"),
    ("영업손실 · T=2022",          0.0006, "채택"),
    ("영업손실 · T=2023",          0.0076, "채택"),
    ("당기순손실 · T=2021",         0.0005, "채택"),
    ("당기순손실 · T=2022",         0.0052, "채택"),
    ("당기순손실 · T=2023",         0.0005, "채택"),
    ("부채비율 200%↑ · T=2023",     0.0006, "3시점 중 1시점만 판정 — 채택 안 함"),
    ("매출 감소 · T=2021",          0.1540, "탈락"),
    ("매출 감소 · T=2022",          0.0760, "탈락"),
    ("매출 감소 · T=2023",          0.0510, "탈락"),
    # 구조 — 이쪽은 엣지가 필요하니 그래프 소속을 요구한다
    ("고립(감사의견)",              0.1571, "탈락 — 통제하면 사라짐"),
    ("고립(부실 이벤트) · T=2021",   0.9788, "탈락 — 방향 반대"),
    ("고립(부실 이벤트) · T=2022",   0.8613, "탈락 — 방향 반대"),
    ("고립(부실 이벤트) · T=2023",   0.1070, "탈락"),
    ("고립|재무 조건부 · T=2022",    0.6948, "탈락"),
    ("고립|재무 조건부 · T=2023",    0.0620, "탈락 — 시점 간 갈림"),
